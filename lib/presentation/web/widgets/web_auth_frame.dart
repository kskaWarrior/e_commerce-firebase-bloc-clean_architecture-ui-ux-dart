...
/// centered frosted-glass panel over a branded backdrop, instead of
...
class WebAuthFrame extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Branded backdrop glows for the glass to refract.
          Positioned.fill(
            child: Stack(
              children: [
                _glow(
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: brand.surfaceBright.withOpacity(0.55),
                    borderRadius: BorderRadius.circular(28),
                    border: Border.all(
                  ...
                  // size so it lays out exactly like on a phone. A
                  // transparent scaffold lets the glass show through.
                  child: MediaQuery(
